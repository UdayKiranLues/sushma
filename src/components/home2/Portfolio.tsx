        ...
        <div className="row">
          <div className="col-12 col-md-6 col-lg-4">
            <div data-aos="fade-up" className="zirox-portfolio__item ">
              <div className="zirox-portfolio__item-img zirox-img-overlay">
                <Image width={416} height={392} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/portfolio/portfolio-img-1.png" alt="Technology Services" />
              </div>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div data-aos="fade-up" data-aos-delay="300" className="zirox-portfolio__item ">
              <div className="zirox-portfolio__item-img zirox-img-overlay">
                <Image width={416} height={392} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/portfolio/portfolio-img-2.png" alt="Technology Services" />
              </div>
              <div className="zirox-portfolio__item-icon ">
                <i className="flaticon-team-1"></i>
              </div>
          ...
          <div className="col-12 col-md-6 col-lg-4 ">
            <div data-aos="fade-up" data-aos-delay="800" className="zirox-portfolio__item">
              <div className="zirox-portfolio__item-img zirox-img-overlay">
                <Image width={416} height={392} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/portfolio/portfolio-img-3.png" alt="Technology Services" />
              </div>
              <div className="zirox-portfolio__item-icon ">
                <i className="flaticon-team-1"></i>
              </div>
