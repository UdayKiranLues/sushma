        ...
        <div className="row">
            ...
            <div className="zirox-blog__post">
              <div className="zirox-blog__post-thumbnail">
                <a href="#" target="_blank">
                  <Image width={416} height={281} sizes="100vw" style={{ width: "100%", height: "auto" }} src="/img/blog/thumbnail-4.png" alt="Post Thumbnail" />
                </a>
              </div>
              <div className="zirox-blog__post-body">
                ...
                <Link href="/blogs/1" className="zirox-blog__post-body-read-more">
          ...
          <div data-aos="fade-up" data-aos-delay="300" className="col-12 col-md-6 col-lg-4">
            <div className="zirox-blog__post">
              <div className="zirox-blog__post-thumbnail">
                <a href="#" target="_blank">
                  <Image width={416} height={281} sizes="100vw" style={{ width: "100%", height: "auto" }} src="/img/blog/thumbnail-5.png" alt="Post Thumbnail" />
                </a>
              </div>
              <div className="zirox-blog__post-body">
                <div className="zirox-blog__post-body-date">
          ...
          <div data-aos="fade-up" data-aos-delay="600" className="col-12 col-md-6 col-lg-4">
            <div className="zirox-blog__post">
              <div className="zirox-blog__post-thumbnail">
                <a href="#" target="_blank">
                  <Image width={416} height={281} sizes="100vw" style={{ width: "100%", height: "auto" }} src="/img/blog/thumbnail-6.png" alt="Post Thumbnail" />
                </a>
              </div>
              <div className="zirox-blog__post-body">
                <div className="zirox-blog__post-body-date">
