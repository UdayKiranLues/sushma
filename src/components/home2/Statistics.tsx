    ...
    <section className="zirox-stats position-relative z-1">
      <div className="container">
        <div className="zirox-stats__vectors">
          <Image width={279} height={270} sizes="100vw" className="zirox-stats__vectors-left" src="/img/stats/stats-vector-left.png" alt="Left vector" />
          <Image width={279} height={270} sizes="100vw" className="zirox-stats__vectors-right" src="/img/stats/stats-vector-right.png" alt="Right vector" />
        </div>
        <div className="row">
