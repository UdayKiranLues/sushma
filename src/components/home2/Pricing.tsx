  ...
  return (
    <section className="zirox-pricing zirox-section">
      <div className="zirox-pricing__vectors">
        <Image width={633} height={522} sizes="100vw" className="zirox-pricing__vectors-left" src="/img/pricing/pricing-left-vector.png" alt="Left Vector" />
        <Image  width={375} height={428} sizes="100vw" className="zirox-pricing__vectors-right" src="/img/pricing/pricing-right-vector.png" alt="Right Vector" />
