          ...
          <div className="col-12 col-lg-6">
            <div className="zirox-about__left">
              ...
              <div data-aos="fade-up" data-aos-delay="600" className="zirox-about__left-ceo ">
                <Image width={80} height={80} sizes="100vw" className="zirox-about__left-ceo-avatar" src="/img/about/ceo.png" alt="CEO" />
                <Image  width={170} height={85} sizes="100vw" className="zirox-about__left-ceo-signature" src="/img/about/signature.png" alt="Signature" />
          ...
          <div className="col-12 col-lg-6">
            <div className="zirox-about__right ">
              <div className="zirox-about__right-img zirox-img-overlay">
                <Image width={572} height={683} sizes="100vw" style={{width:"100%", height:"auto"}} data-aos="fade-up" data-aos-delay="700" src="/img/about/home-3-about-right.png" alt="Image" />
              </div>
              <a href="#">
