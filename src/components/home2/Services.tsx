  ...
  return (
    <section className="zirox-services zirox-services--popular-services zirox-section">
      <div className="zirox-services__vectors">
        <Image  width={572} height={576} sizes="100vw" className="zirox-services__vectors-left" src="/img/services/service-left-vector.png" alt="Left Vector" />
        <Image  width={224} height={535} sizes="100vw" className="zirox-services__vectors-right" src="/img/services/service-right-vector.png" alt="Right Vector" />
