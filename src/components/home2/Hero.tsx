                ...
                <div className="zirox-hero__left">
                  <div className="zirox-hero__left__content ">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                      <Link href="/contact" className="zirox-button zirox-button-third ">
                        Get Solution
                      </Link>
                    </div>
                  </div>
              ...
              <div className="col-12 col-md-12 col-lg-7 d-flex align-items-center">
                <div className="zirox-hero__left">
                  <div className="zirox-hero__left__content">
                    ...
                    <Link data-aos="fade-up" data-aos-delay="600" href="/contact" className="zirox-button zirox-button-third ">
                      Get Solution
                    </Link>
                  </div>
                </div>
