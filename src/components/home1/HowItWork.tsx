        ...
        <div className="row">
            ...
            <a data-aos="fade-up" href="#">
              <div className="zirox-how-it-work-item ">
                <div className="zirox-how-it-work-item-img">
                  <Image width={356} height={237} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/how-it-work/work-1.png" alt="Web Development" />
                </div>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <a data-aos="fade-up" data-aos-delay="300" href="#">
              <div className="zirox-how-it-work-item ">
                <div className="zirox-how-it-work-item-img">
                  <Image width={356} height={237} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/how-it-work/work-2.png" alt="Engine Optimization" />
                </div>
                <div className="zirox-how-it-work-item-icon">
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <a data-aos="fade-up" data-aos-delay="600" href="#">
              <div className="zirox-how-it-work-item ">
                <div className="zirox-how-it-work-item-img">
                  <Image width={356} height={237} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/how-it-work/work-3.png" alt="Design & Concept" />
                </div>
                <div className="zirox-how-it-work-item-icon">
