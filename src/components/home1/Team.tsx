        ...
        <div className="row">
          <div className="col-12 col-md-6 col-lg-3">
            <div data-aos="fade-up" className="zirox-team-item ">
              <Image width={306} height={363} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/team/member-4.png" alt="Member-1" />
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div data-aos="fade-up" data-aos-delay="300" className="zirox-team-item ">
              <Image width={306} height={363} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/team/member-5.png" alt="Member-2" />
              <div className="zirox-team-item__info">
                <p className="text-center">Designer</p>
                <h3 className="text-center">Mike Hardson</h3>
              </div>
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div data-aos="fade-up" data-aos-delay="600" className="zirox-team-item ">
              <Image width={306} height={363} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/team/member-6.png" alt="Member-3" />
              <div className="zirox-team-item__info">
                <p className="text-center">Designer</p>
                <h3 className="text-center">Mike Hardson</h3>
              </div>
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div data-aos="fade-up" data-aos-delay="900" className="zirox-team-item ">
              <Image width={306} height={363} sizes="100vw" style={{width:"100%", height:"auto"}} src="/img/team/member-7.png" alt="Member-3" />
              <div className="zirox-team-item__info">
                <p className="text-center">Designer</p>
                <h3 className="text-center">Mike Hardson</h3>
              </div>
